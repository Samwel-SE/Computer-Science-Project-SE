...
def generate_maps():
    ...
    map_1 = perlinnoise.generate(1300, 50)
...
def threaded_client(conn, client_num, maps):
    ...
    while True:
        ...
        if not(data) or data == "DISCONNECT":
            ...
            player_data[client_num] = starting_player_data[client_num]
        ...
        #sends data of client 0 to client 1
        if client_num == 1:
            reply = player_data[0]

        # sends data of client 1 to client 0
        else: 
            reply = player_data[1]
